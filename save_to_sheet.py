...
def save_to_sheet(bico_data, tanque_data, file_path):
    ...
    headers = ["Bico", "Produto", "Abertura", "Fechamento", "Sem_intervencao", "Com_intervencao", "Afericao", "Obs"]
    ...
    # Define o cabeçalho (se necessário)
    headers_tanque = ["Tanque", "Produto", "Abertura", "Fechamento", "Recebimento", "Obs"]
